...
<body>
    ...
    <div id="main">
        ...
        <div id="wrapper">
            ...
            <!------------------------------------>
    <div id="stats">
        <div class="stat-container" onscroll="btnClick()">
            <button id="count-btn" onclick="startCount();" style="display: none;">Count</button>
            <div class="stat-heading">
                <h1>Our history in numbers</h1>
            </div>
            <div class="stat-content">
                <div class="stat-box">
                    <i class="fas fa-map-marker-alt" style="font-size: 50px ;"></i>
                    <div class="statistics" data-stop-count="15">
                        <span>0</span>
                    </div>
                    <span>Locations</span>
                </div>
                ...
                <div class="stat-box">
                    <i class="fas fa-couch" style="font-size: 50px ;"></i>
                    <div class="statistics" data-stop-count="5600">
                        <span>0</span>
                    </div>
                ...
                <div class="stat-box">
                    ...
                    <div class="statistics" data-stop-count="835">
                        <span>0</span>
                    </div>
                    <span>Employees</span>
                </div>
...
<!-- ------------------------NewProductsSectionCarousel----------------- -->
<section id="second-carousel">
<div id="wrapper2">
    <div id="carousel2">
        <h2 id="title">New Products</h2><br>
        <div class="container-second">
            ...
            <div class="card">
                ...
                <div class="contentBx">
                    ...
                    <h2>Aesthetic living room table</h2>
    ...
    <div class="quote-container">
        ...
        <div class="quote-body">
            <div class="quote">
                <span>"If you look at what you have in life, you'll always have more. If you look at what you don't have in life, you'll never have enough."</span>
            </div>
            <div class="author">
                - Oprah Winfrey
            </div>
            <div class="quote-buttons">
                <div class="quote-btn">
                    <button id="generate-btn">Pick one</button>
                </div>
                <div class="tweet-quote" style="display: none;">
                    <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" target="_blank">
                        <span>Tweet it!</span>
                        <i class="fa fa-twitter"></i>
                    </a>
                    <br />
                    <span id="already-picked">(Come back tomorrow to pick another one&excl;)</span>
                </div>
            </div>
        </div>
    </div>
