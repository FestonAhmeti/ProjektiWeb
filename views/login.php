...
<?php } else { ?>
    <div class="llogaria-main">            
        ...
        <form method="POST" action="../programLogic/AccountVerification.php" id='llogaria-form'>
            ...
            <div class="register form hidden">
                ...
                <input type="submit" name="register" id="register-submit-btn" class="input button" value="Regjistrohu" id="submit-btn">
